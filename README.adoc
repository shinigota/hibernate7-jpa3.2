...
La fonctionnalité, propre à JPA, peut être complexe à prendre en main. Hibernate propose maintenant son annotation `@NamedEntityGraph`, plus simple à putiliser. +
